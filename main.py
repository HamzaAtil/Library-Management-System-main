...
# Redimensionnement de l'image avec LANCZOS (anciennement ANTIALIAS)
button_image = button_image.resize((110, 40), Image.LANCZOS)

# Création de l'objet PhotoImage pour Tkinter
